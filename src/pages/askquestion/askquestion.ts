...
export class AskquestionPage {
  ...
  constructor(private formpagesProvider:FormpagesProvider,public navCtrl: NavController,private storage: Storage, public navParams: NavParams,private toastCtrl: ToastController,private translate: TranslateService) {
  }
  getLangDat(lang:any){
      this.lang = lang;
  }
    ...
    askquestionForm(formData) {
        ...
        this.formpagesProvider.askQuestion(this.nameValue,this.countryValue,this.emailValue,this.messageValue,this.lang).then(data=>{
