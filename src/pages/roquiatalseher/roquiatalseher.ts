...
/**
 * Generated class for the RoquiatalseherPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-roquiatalseher',
  templateUrl: 'roquiatalseher.html',
})
export class RoquiatalseherPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad RoquiatalseherPage');
  }
  settingMusicControl(index){
    ...
    ngOnInit() {
        ...
        this.soundOfArray[1] =  ["374d1e5a9e2ef48c8b71bd11b96857ed.mp3","https://healingofthequran.com/menu/7.mp3","roquiatalseher","رقية السحر",'1'];
        this.soundOfArray[2] =  ["2eae79b5bf05a9e1b8f80f9e514f98a3.mp3","https://healingofthequran.com/menu/8.mp3","roquiatalseher","رقية السحر",'2'];
        this.soundOfArray[3] = ["c2d562272059c376b9aaaea51659514c.mp3","https://healingofthequran.com/menu/9.mp3","roquiatalseher","رقية السحر",'3'];
    ...
    downloadeRecordingAndroid(index:any){
        ...
        this.translate.get('roquiatalseher').subscribe( value => {
    ...
    playRecording() {
        this.storage.get('changeSound').then((val) => {
            this.redingType = val;
            this.formpagesProvider.watchList(this.soundOfArray[val][3],'2',51,this.soundOfArray[val][2],this.soundOfArray[val][1]).then(data=>{})
            for(let i=1;i<this.soundOfArray.length;i++){
