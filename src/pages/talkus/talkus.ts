...
@IonicPage()
@Component({
  selector: 'page-talkus',
  templateUrl: 'talkus.html',
})
export class TalkusPage {
    ...
    talkusForm(formData) {
        ...
        this.formpagesProvider.talkus(this.nameValue,this.countryValue,this.emailValue,this.messageValue,this.lang).then(data=>{
